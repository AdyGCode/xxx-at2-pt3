                ...
                <div class="p-6 bg-white border-b border-gray-200 flex flex-center gap-8">
                    ...
                    overflow-hidden mx-0">
                        <div class="flex justify-between gap-4">
                            <p>
                                <i class="fa fa-solid fa-car-side text-3xl lg:text-6xl text-emerald-500 ml-4 pt-6"></i>
                            </p>
                    ...
                    overflow-hidden">
                        <div class="flex justify-between gap-4">
                            <p>
                                <i class="fa fa-solid fa-address-book text-3xl lg:text-6xl text-rose-500 ml-4 pt-6"></i>
                            </p>
                    ...
                    overflow-hidden">
                        <div class="flex justify-between gap-4">
                            <p>
                                <i class="fa fa-solid fa-user text-3xl lg:text-6xl text-indigo-500 ml-4 pt-6"></i>
                            </p>
