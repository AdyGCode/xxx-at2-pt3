        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-4">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <h2 class="text-3xl pb-6">Development Environment Access Points</h2>
                    <p class="pb-6">When using Docker and Sail with the <code>docker-compose.yaml</code> file from this project,
